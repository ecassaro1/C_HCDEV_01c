 ...
 */
export class Sales_Totals_By_AmountsRequestBuilder<
...
> extends RequestBuilder<Sales_Totals_By_Amounts<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Sales_Totals_By_Amounts<T>, T> {
    return new GetAllRequestBuilder<Sales_Totals_By_Amounts<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<Sales_Totals_By_Amounts<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Sales_Totals_By_Amounts<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<Sales_Totals_By_Amounts<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<Sales_Totals_By_Amounts<T>, T>(
      this.entityApi,
      companyNameOrEntity instanceof Sales_Totals_By_Amounts
        ? companyNameOrEntity
        : {
