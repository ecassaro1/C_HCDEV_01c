...
class CategoriesApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            PRODUCTS: new odata_v4_1.OneToManyLink('Products', this, linkedApis[0])
        };
        return this;
    }
    requestBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(Categories_1.Categories, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', Categories_1.Categories)
            };
        }
        return this._schema;
    }
