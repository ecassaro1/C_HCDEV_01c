 ...
 */
export class Products_By_CategoriesRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<Products_By_Categories<T>, T> {
  /**
  ...
  getAll(): GetAllRequestBuilder<Products_By_Categories<T>, T> {
    return new GetAllRequestBuilder<Products_By_Categories<T>, T>(
      this.entityApi
    );
  }
   ...
   */
  create(
    entity: Products_By_Categories<T>
  ): CreateRequestBuilder<Products_By_Categories<T>, T> {
    return new CreateRequestBuilder<Products_By_Categories<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): GetByKeyRequestBuilder<Products_By_Categories<T>, T> {
    return new GetByKeyRequestBuilder<Products_By_Categories<T>, T>(
      this.entityApi,
      {
  ...
  update(
    entity: Products_By_Categories<T>
  ): UpdateRequestBuilder<Products_By_Categories<T>, T> {
    return new UpdateRequestBuilder<Products_By_Categories<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    productName: string
  ): DeleteRequestBuilder<Products_By_Categories<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `Products_By_Categories`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<Products_By_Categories<T>, T>(
      this.entityApi,
      categoryNameOrEntity instanceof Products_By_Categories
