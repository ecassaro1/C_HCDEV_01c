 ...
 */
export class Product_Sales_For_1997RequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<Product_Sales_For_1997<T>, T> {
  /**
  ...
  getAll(): GetAllRequestBuilder<Product_Sales_For_1997<T>, T> {
    return new GetAllRequestBuilder<Product_Sales_For_1997<T>, T>(
      this.entityApi
    );
  }
   ...
   */
  create(
    entity: Product_Sales_For_1997<T>
  ): CreateRequestBuilder<Product_Sales_For_1997<T>, T> {
    return new CreateRequestBuilder<Product_Sales_For_1997<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): GetByKeyRequestBuilder<Product_Sales_For_1997<T>, T> {
    return new GetByKeyRequestBuilder<Product_Sales_For_1997<T>, T>(
      this.entityApi,
      {
  ...
  update(
    entity: Product_Sales_For_1997<T>
  ): UpdateRequestBuilder<Product_Sales_For_1997<T>, T> {
    return new UpdateRequestBuilder<Product_Sales_For_1997<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    categoryName: string,
    productName: string
  ): DeleteRequestBuilder<Product_Sales_For_1997<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `Product_Sales_For_1997`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<Product_Sales_For_1997<T>, T>(
      this.entityApi,
      categoryNameOrEntity instanceof Product_Sales_For_1997
