...
export class Order_DetailsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<Order_Details<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new Order_DetailsApi(deSerializers);
  }
  ...
  _addNavigationProperties(
    linkedApis: [OrdersApi<DeSerializersT>, ProductsApi<DeSerializersT>]
  ): this {
    this.navigationPropertyFields = {
      ORDER: new OneToOneLink('Order', this, linkedApis[0]),
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<Order_Details<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<Order_Details<DeSerializersT>, DeSerializersT, NullableT> {
