 ...
 */
export class Alphabetical_List_Of_ProductsRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<Alphabetical_List_Of_Products<T>, T> {
  /**
  ...
  getAll(): GetAllRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new GetAllRequestBuilder<Alphabetical_List_Of_Products<T>, T>(
      this.entityApi
    );
  }
   ...
   */
  create(
    entity: Alphabetical_List_Of_Products<T>
  ): CreateRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new CreateRequestBuilder<Alphabetical_List_Of_Products<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): GetByKeyRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new GetByKeyRequestBuilder<Alphabetical_List_Of_Products<T>, T>(
      this.entityApi,
      {
  ...
  update(
    entity: Alphabetical_List_Of_Products<T>
  ): UpdateRequestBuilder<Alphabetical_List_Of_Products<T>, T> {
    return new UpdateRequestBuilder<Alphabetical_List_Of_Products<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    productId: number,
    productName: string
  ): DeleteRequestBuilder<Alphabetical_List_Of_Products<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `Alphabetical_List_Of_Products`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<Alphabetical_List_Of_Products<T>, T>(
      this.entityApi,
      categoryNameOrEntity instanceof Alphabetical_List_Of_Products
