 ...
 */
export class Order_Details_ExtendedsRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<Order_Details_Extendeds<T>, T> {
  /**
  ...
  getAll(): GetAllRequestBuilder<Order_Details_Extendeds<T>, T> {
    return new GetAllRequestBuilder<Order_Details_Extendeds<T>, T>(
      this.entityApi
    );
  }
   ...
   */
  create(
    entity: Order_Details_Extendeds<T>
  ): CreateRequestBuilder<Order_Details_Extendeds<T>, T> {
    return new CreateRequestBuilder<Order_Details_Extendeds<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): GetByKeyRequestBuilder<Order_Details_Extendeds<T>, T> {
    return new GetByKeyRequestBuilder<Order_Details_Extendeds<T>, T>(
      this.entityApi,
      {
        Discount: discount,
        OrderID: orderId,
  ...
  update(
    entity: Order_Details_Extendeds<T>
  ): UpdateRequestBuilder<Order_Details_Extendeds<T>, T> {
    return new UpdateRequestBuilder<Order_Details_Extendeds<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    quantity: number,
    unitPrice: BigNumber
  ): DeleteRequestBuilder<Order_Details_Extendeds<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `Order_Details_Extendeds`.
  ...
  delete(
    ...
    return new DeleteRequestBuilder<Order_Details_Extendeds<T>, T>(
      this.entityApi,
      discountOrEntity instanceof Order_Details_Extendeds
        ? discountOrEntity
        : {
