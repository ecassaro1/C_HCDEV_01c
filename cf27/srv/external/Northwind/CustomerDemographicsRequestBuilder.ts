 ...
 */
export class CustomerDemographicsRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerDemographics<T>, T> {
  /**
   ...
   */
  create(
    entity: CustomerDemographics<T>
  ): CreateRequestBuilder<CustomerDemographics<T>, T> {
    return new CreateRequestBuilder<CustomerDemographics<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): GetByKeyRequestBuilder<CustomerDemographics<T>, T> {
    return new GetByKeyRequestBuilder<CustomerDemographics<T>, T>(
      this.entityApi,
  ...
  update(
    entity: CustomerDemographics<T>
  ): UpdateRequestBuilder<CustomerDemographics<T>, T> {
    return new UpdateRequestBuilder<CustomerDemographics<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  ): DeleteRequestBuilder<CustomerDemographics<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `CustomerDemographics`.
  ...
  delete(
    customerTypeIdOrEntity: any
  ): DeleteRequestBuilder<CustomerDemographics<T>, T> {
    return new DeleteRequestBuilder<CustomerDemographics<T>, T>(
      this.entityApi,
      customerTypeIdOrEntity instanceof CustomerDemographics
        ? customerTypeIdOrEntity
        : { CustomerTypeID: customerTypeIdOrEntity! }
    );
  }
}
