 ...
 */
class ShippersRequestBuilder extends odata_v4_1.RequestBuilder {
    /**
    ...
    delete(shipperIdOrEntity) {
        return new odata_v4_1.DeleteRequestBuilder(this.entityApi, shipperIdOrEntity instanceof Shippers_1.Shippers
            ? shipperIdOrEntity
