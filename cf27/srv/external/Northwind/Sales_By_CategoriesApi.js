...
class Sales_By_CategoriesApi {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v4_1.FieldBuilder(Sales_By_Categories_1.Sales_By_Categories, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v4_1.AllFields('*', Sales_By_Categories_1.Sales_By_Categories)
            };
        }
        return this._schema;
    }
